...
public class CLUHelper
{
    ...
    public CLUHelper(IConfiguration configuration)
    {
        ...
        _endpoint = cluConfig["Endpoint"] ?? throw new ArgumentNullException("Endpoint");
        _apiKey = cluConfig["ApiKey"] ?? throw new ArgumentNullException("ApiKey");
        _projectName = cluConfig["ProjectName"] ?? throw new ArgumentNullException("ProjectName");
        _deploymentName = cluConfig["DeploymentName"] ?? throw new ArgumentNullException("DeploymentName");
